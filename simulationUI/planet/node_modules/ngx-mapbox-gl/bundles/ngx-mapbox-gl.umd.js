(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@turf/bbox'), require('@turf/helpers'), require('mapbox-gl'), require('supercluster'), require('@angular/core'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('ngx-mapbox-gl', ['exports', '@angular/common', '@turf/bbox', '@turf/helpers', 'mapbox-gl', 'supercluster', '@angular/core', 'rxjs', 'rxjs/operators'], factory) :
    (factory((global['ngx-mapbox-gl'] = {}),global.ng.common,global.bbox,global.helpers,global.MapboxGl,global.supercluster,global.ng.core,global.rxjs,global.rxjs.operators));
}(this, (function (exports,common,bbox,helpers,MapboxGl,supercluster,core,rxjs,operators) { 'use strict';
         ...
         */
            function (events) {
                ...
                if (events.idle.observers.length) {
                    this.mapInstance.on('idle', function () { return _this.zone.run(function () { return events.idle.emit(); }); });
                }
            };
         ...
         */
            function () {
                ...
                this.MapService.mapCreated$.subscribe(function () {
                    ...
                    // @ts-ignore
                    _this.ControlComponent.control = new MapboxGl.FullscreenControl(options); // @types/mapbox-gl update needed
                    _this.MapService.addControl(_this.ControlComponent.control, _this.ControlComponent.position);
                });
            };
