...
export class EightNodeElGridComponent implements OnInit {
    ...
    roomSvg = {
        ...
        rooms: [
            {
                id: '0',
                name: { text: 'Node 1', x: 15, y: 5 },
                number: {
                    text: '', x: 415, y: 20.1,
                    text2: '', x2: 435, y2: 4.1,
                },
                area: {
                    d: `M 100,0 L 450,0 M 280,0 V 25 M 200,25 L 420,25 M 365,25 V38 a 13,11 0 1,0 1,0 M 365,50 a 13,11 0 1,0 1,0Z
        M 365,71 V94 M 366, 95 L 350, 80 M 364, 95 L 380, 80 M 230,25 V 64 M 231,64 L 215,50  M 229,64 L 245, 50` },
            ...
            },
            {
                ...
                area: {
                    d: `M 200,105 L 420,105 M 280,25 V 105 M 365,105 V118 a 13,11 0 1,0 1,0 M 365,130 a 13,11 0 1,0 1,0Z
       M 365,151 V174 M 366, 175 L 350, 160 M 364, 175 L 380, 160` },
            ...
            },
            {
                ...
                area: {
                    d: `M 200,185 L 420,185 M 280,105 V 185 M 365,185 V198 a 13,11 0 1,0 1,0 M 365,210 a 13,11 0 1,0 1,0Z
           M 365,231 V254 M 366, 255 L 350, 240 M 364, 255 L 380, 240`,
            ...
            },
            {
                ...
                area: {
                    d: `M 200,265 L 420,265 M 280,185 V 265 M 365,265 V278 a 13,11 0 1,0 1,0 M 365,290 a 13,11 0 1,0 1,0Z
          M 365,311 V334 M 366, 335 L 350, 320 M 364, 335 L 380, 320` },
            ...
            },
            {
                ...
                area: {
                    d: `M 200,345 L 420,345 M 280,265 V 345 M 365,345 V358 a 13,11 0 1,0 1,0 M 365,370 a 13,11 0 1,0 1,0Z
           M 365,391 V414 M 366, 415 L 350, 400 M 364, 415 L 380, 400` },
            ...
            },
            {
                ...
                area: {
                    d: `M 150,425 L 420,425 M 280,345 V 425 M 365,425 V438 a 13,11 0 1,0 1,0 M 365,450 a 13,11 0 1,0 1,0Z
          M 365,471 V494 M 366, 495 L 350, 480 M 364, 495 L 380, 480` },
            ...
            },
            {
                ...
                area: {
                    d: `M 200,505 L 420,505 M 280,425 V 505 M 365,505 V518 a 13,11 0 1,0 1,0 M 365,530 a 13,11 0 1,0 1,0Z
          M 365,551 V574 M 366, 575 L 350, 560 M 364, 575 L 380, 560 M 230,505 V 544 M 231,544 L 215,530  M 229,544 L 245, 530` },
            ...
            },
            {
                ...
                area: {
                    d: `M 200,585 L 420,585 M 280,505 V 585 M 365,585 V598 a 13,11 0 1,0 1,0 M 365,610 a 13,11 0 1,0 1,0Z
