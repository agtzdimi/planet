        ...
        this.httpClient.post(url, formData,
            ...
            .subscribe(
                (timeStamp) => {
                    ...
                    this.windParam['payload']['formName'] = this.paramInit['payload']['formName'];
                    this.windParam['payload']['formDescription'] = this.paramInit['payload']['formDescription'];
                    this.windParam['payload']['startDate'] = startDate;
                    this.windParam['payload']['endDate'] = endDate;
                    this.pvParam['payload']['formName'] = this.paramInit['payload']['formName'];
                    this.pvParam['payload']['formDescription'] = this.paramInit['payload']['formDescription'];
