...
export class GeneralParamsComponent implements AfterViewInit, OnInit, AfterContentChecked, OnDestroy {
  ...
  @Output() disSimPar: EventEmitter<void>;
  @Output() enSimPar: EventEmitter<void>;
 ...
 */
  constructor(private model1: Model1ParamInitService,
    ...
    this.disSimPar = new EventEmitter<void>();
    this.enSimPar = new EventEmitter<void>();
  ...
  */
  public onRadioButtonClicked(radioButtonText: Object): void {
    ...
    this.resizeMap();
    /**disable Simulation Parameters*/
    this.disSimPar.emit();

    /**enable Simulation Parameters after 150ms*/
    setTimeout(() => {
      this.enSimPar.emit();
 }, 150);
  }
